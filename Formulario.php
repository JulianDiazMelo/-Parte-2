	...
	<section class="container">
		...
		<h3 class="center-align">Formulario</h3>
			<article class="col s6 offset-s3">
				<form method="POST" action="guardado.php"><!-- Se asigna el destino donde se va a enviar lainformacion ingresada -->
					<div class="input-field"><!-- Se implementar los espacios para ingresar la informacion -->
					...
					<p class="center-align"><!-- Se implementar el boton de envio de informacion -->
